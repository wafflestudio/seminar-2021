...
import com.wafflestudio.seminar.global.auth.GeneralAuthenticationFilter
import com.wafflestudio.seminar.global.auth.JwtAuthenticationEntryPoint
import com.wafflestudio.seminar.global.auth.JwtAuthorizationFilter
...
//        return Argon2PasswordEncoder()
    ...
    override fun configure(http: HttpSecurity) {
        http
            ...
            .antMatchers(HttpMethod.POST, "/api/v1/users/").permitAll()  // SignUp user
