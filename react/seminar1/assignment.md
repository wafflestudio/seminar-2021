...
- 스펙
  ...
  4. 리스트
      ...
      - `추가` 버튼을 클릭하면 학생을 추가할 수 있는 모달이 뜬다.
        ...
        - 모달이 열리고 닫힐 때는 서서히 열리고 서서히 닫히는 transition이 있다. ([이 사이트](https://getbootstrap.com/docs/4.0/components/modal/#vertically-centered)에서 모달이 열리고 닫히는 방식 참고)
...
- ***채점 결과, 세미나장 및 TA가 판단하기에 제출본이 미흡할 경우 과제가 통과되지 않을 수 있습니다.***
