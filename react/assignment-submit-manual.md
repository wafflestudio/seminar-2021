...
1. 자신의 GitHub 개인 계정에 `waffle-rookies-19.5-react-assignment-${세미나 번호}` 이라는 이름으로 private repository를 개설합니다. 개설할 때 Add a README file을 체크해 주세요.
...
3. repository를 clone하고, `assignment`라는 이름의 브랜치를 master에서 체크아웃하고, 해당 브랜치에서 과제를 진행해 주세요.
