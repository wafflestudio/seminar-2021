...
## 과제 1 - `HTML` `CSS` `JS` 로 와플고등학교 인원 관리 프로그램 만들기
1. 구현하기 까다로운 만큼 스펙을 정말정말 많이 간소화했습니다.
   - 학생의 정보는 `이름` 만 있고, 기능 역시 `추가` 기능만 있습니다.
2. [예제 사이트](http://rookies-seminar-0-assignment-example-website.s3-website.ap-northeast-2.amazonaws.com)를 만들어 두었으니, 확인하시고 적당히 비슷하게 만들어 주시기 바랍니다.
...
1. 가능한 한 꼼꼼하고 정확하게 주석을 달아 주시기 바랍니다.
